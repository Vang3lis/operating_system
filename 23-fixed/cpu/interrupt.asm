...
isr_common_stub:
	; 1. Save CPU state
	pusha ; pusha == push eax; push ecx; edx,ebx,esp,ebp,esi,edi
	mov ax, ds;
	push eax;
	...
	mov fs, ax
	mov gs, ax
    push esp ; push register* content
	...
	; 3. Restore state
	pop eax ; pop callee function's paramter
    pop eax 
	mov ds, ax
	mov es, ax
	mov fs, ax
...
; Common IRQ code. Indentical to ISR code except for the "call" and "pop ebx"
irq_common_stub:
    pusha 
    mov ax, ds
    push eax
...
; 7: Coprocessor Not Availale Exception
isr7:
    push byte 0
    push byte 7
    jmp isr_common_stub
...
; 8: Double Fault Excetion (With Error Code!)
isr8:
    push byte 8
    jmp isr_common_stub
